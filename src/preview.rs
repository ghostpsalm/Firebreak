...
fn usage(id: &str, allow: i64, block: i64, last_min_ago: i64, apps: &[(&str, i64)]) -> RuleUsage {
    RuleUsage {
        ...
        distinct_peers: 3,
        by_profile: vec![
            ("Domain".into(), allow / 2, block),
            ("Private".into(), allow - allow / 2, 0),
        ],
    }
}
...
pub fn run() -> Result<()> {
    ...
    let specs: Vec<(RuleInfo, Option<RuleUsage>, Vec<&str>, Option<bool>)> = vec![
        (
            rule(
                "2C5D8F41-9B0A-4E77-A1C3-6F2B90D4E815",
            ...
            Some(usage(
                ...
                4,
                &[
                    (r"C:\Windows\System32\svchost.exe", 1198),
                    (r"C:\Windows\System32\mstsc.exe", 6),
                ],
            )),
            vec!["Remote Desktop Services"],
            None,
        ),
        (
            rule(
        ...
        (
            ...
            Some(usage(
                ...
                &[
                    ...
                    (r"%USERPROFILE%\AppData\Roaming\Spotify\Spotify.exe", 4860),
                ],
            )),
            vec!["Google Chrome (Google LLC)", "Spotify (Spotify AB)"],
            None,
        ),
        (
            rule(
            ...
            vec!["Google Chrome (Google LLC)", "msedge"],
            None,
        ),
        (
            rule(
                ...
                "Domain, Private",
                Some("OpenSSH Server"),
                Some(r"%SystemRoot%\System32\OpenSSH\sshd.exe"),
                Some("TCP"),
                Some("22"),
                None,
            ...
            Some(usage(
                ...
                0,
                122,
                &[(r"C:\Windows\System32\OpenSSH\sshd.exe", 96)],
            )),
            vec!["OpenSSH"],
            None,
        ),
        (
            rule(
                ...
                "Domain, Private, Public",
                None,
                Some(r"C:\Program Files (x86)\AnyDesk\AnyDesk.exe"),
                Some("TCP"),
                None,
                None,
            ...
            Some(usage(
                ...
                0,
                8640,
                &[(r"C:\Program Files (x86)\AnyDesk\AnyDesk.exe", 8)],
            )),
            vec!["AnyDesk"],
            None,
        ),
        (
            rule(
                "a7",
                "Xbox Game UI (TCP-Out)",
                true,
                "Outbound",
                "Allow",
                "Any",
                None,
                Some(r"C:\Program Files\WindowsApps\GamingServices\gamingservices.exe"),
                Some("TCP"),
                None,
                None,
            ...
            None,
            vec![],
            Some(false), // pending disable
        ),
        (
            rule(
                "a8",
                "TeamViewer Remote (TCP-In)",
                true,
                "Inbound",
                "Allow",
                "Domain, Private, Public",
                None,
                Some(r"C:\Program Files\TeamViewer\TeamViewer.exe"),
                Some("TCP"),
                Some("5938"),
                None,
        ...
        (
            rule(
                ...
                "Allow",
                "Domain",
                Some("Windows Remote Management"),
                Some("System"),
                Some("TCP"),
                Some("5985"),
                None,
